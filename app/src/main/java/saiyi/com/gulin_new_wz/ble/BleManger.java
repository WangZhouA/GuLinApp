...
public class BleManger {
    ...
    public void setBdwReadI(BDWReadI bdwReadI) {
        this.bdwReadI = bdwReadI;
    }
    ...
    private final BleConnectStatusListener mBleConnectStatusListener = new BleConnectStatusListener() {
        ...
        public void onConnectStatusChanged(String mac, int status) {
            if (status == STATUS_CONNECTED) {
                ...
                //连接断开了
//                Intent intent =new Intent(BleConstant.DUANKAI);
//                context.sendBroadcast(intent);
     ...
     * 发送消息
     */
    public void sendCmd(String mac, String serviceUUIDstr, String characterUUIDstr, final byte[] bytes) {
        ...
        mClient.write(mac, serviceUUID, characterUUID, bytes, new BleWriteResponse() {
            ...
            public void onResponse(int code) {
                ...
                if (code == Constants.REQUEST_SUCCESS) {
                    ...
                    bdwReadI.onWriteCharSuccess(new String(bytes));
    ...
    public void openNotify(String mac, String serviceUUIDstr, String characterUUIDstr) {
        ...
        mClient.indicate(mac, serviceUUID, characterUUID, new BleNotifyResponse() {
            ...
            public void onNotify(UUID service, UUID character, byte[] value) {
                LogUtils.e("收到byte（ZZ）=======" +new String(value));
                bdwReadI.onCharacteristicChanged(value);
            }
