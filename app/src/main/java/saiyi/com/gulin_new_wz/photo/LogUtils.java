...
public final class LogUtils {
	...
	public static void d(Object obj) {
		if (Log.DEBUG > DEBUG_LEVEL && debugMode) {
			String tag = getClassName();
			String msg = obj != null ? obj.toString() : "obj == null";
			Log.d(tag, msg);
		}
	...
	/**
	 * Send a {@link Log#VERBOSE} log message. And just print
	 * method name and position in black.
	 */
	public static void print() {
		if (Log.VERBOSE > DEBUG_LEVEL && debugMode) {
			String tag = getClassName();
