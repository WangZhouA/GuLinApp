 ...
 */
public class BaseCharView extends ChartView {
    ...
    public BaseCharView(Context context, AttributeSet attrs) {
        super(context, attrs);

    }

    public BaseCharView(Context context, AttributeSet attrs, int defStyle) {
