...
import saiyi.com.gulin_new_wz.utils.SignUtils;
...
public class SignSeekBar extends View {
    ...
    private void initConfigByPriority() {
        ...
        mDelta = mMax - mMin;
        Log.d("BluetoothUtil", String.format("initConfigByPriority max:%s min:%s mDelta:%s", mMax, mMin, mDelta));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isThumbOnDragging) {
            ...
            Log.d("BluetoothUtil", String.format("progress:%s mDelta:%s", (mProgress - mMin), mDelta));
        }
    ...
    public void onlySetProgress(float progress){
        mProgress = progress;
        postInvalidate();
    }
